# Claude Code Waypoint Plugin - Hooks Configuration Guide

This guide explains how to configure and customize the hooks system for Claude Code Waypoint Plugin.
